        ...
        <div className="header-top-box">
          ...
          <div className="search-box-bigs">
            ...
            <div className="functionale">
              ...
              <div className="ham-menu">                          {/* menu bar  */}
                <CgMenuRightAlt className="hamburger" onClick={() => setShowDRB(!showDRB)} />
                <motion.div className="drop-bar-menu" style={{ display: showDRB ? "block" : "none" }}
                ...
                >
                  <ul className="bar-menu-list">
                    <li className="close-drop-bar-menu">
                      ...
                      <div className="user"><FaUserAlt /> Shaxsiy kabinet</div>
                    </li>
                    ...
                    <li className="bar-list-item-max">
                      <button className="ln-btn" onClick={() => setShowLn(!showLn)}>Til</button>
                    ...
                    <li className="bar-list-item ln-container" style={{ display: showLn ? "block" : "none" }}>
                    ...
                    <li className="bar-list-item search-item-cont">
                      <form>
                        <input placeholder="izlash" type="text" name="search" id="search-bar" /> <button className="bar-src-btn">Qidruv</button>
                      </form>
                    </li>

                    <li className="bar-list-item-menu" onClick={() => setshowManba(!showManba)}>Manbalar</li>
                    <motion.li className="bar-list-item-manba" style={{ display: showManba ? "block" : "none" }}
                      // initial={{ scale: 0 }}
                    ...
                    >
                      <ul className="manba-bar-drop">
                        <li>
                          <Link className="bar-drop-link" to="/sources/archive"
                        ...
                        <li >
                          <Link className="bar-drop-link" to="/sources/society"
                            onClick={() => setShowDRB(!showDRB)}
                          >
                        ...
                        <li>
                          <Link className="bar-drop-link" to="/sources/manuscript"
                            onClick={() => setShowDRB(!showDRB)}
                          >
                    ...
                    <li className="bar-list-item-menu" ><Link to="/library">Kutubxona</Link></li>
                    <li className="bar-list-item-menu" ><Link to="/news">Yangiliklar</Link> </li>
                    <li className="bar-list-item-menu"><Link >Voqea</Link> </li>
                    <li className="bar-list-item-menu">Bizhaqimizda</li>
                    <li className="bar-list-item-menu" to="/login">Login</li>
                  </ul>
                </motion.div>
              </div>                                                                       {/* menu bar- end  */}
            </div>
