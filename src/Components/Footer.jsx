...
import Logo from "../assets/img/Group 8 (2).svg";
        ...
        <div className="footer-bottom-box">
          <div className="footer-icons">
            ...
            <div className="footer-icons-box">
              ...
              <div>
                <a className="footer-insta icon-box">
                  <FaInstagram />
                </a>
              </div>
              <div>
                <a className="footer-telegram icon-box">
                  <FaTelegramPlane />
                </a>
              </div>
              <div>
                <a className="footer-youtube icon-box">
                  <FaYoutube />
                </a>
              </div>
              <div>
                <a className="footer-facebok icon-box">
                  <FaFacebookF />
                </a>
              </div>
              <div>
                <a className="footer-twitter icon-box">
                  <FaXTwitter />
                </a>{" "}
              </div>
            </div>
